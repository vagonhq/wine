...
{
    UINT32 pointer_count = 1, count = 1;

    TRACE( "id %u, info %p\n", id, info );
    return NtUserGetPointerInfoList( id, PT_TOUCH, 0, 0, sizeof(POINTER_TOUCH_INFO), &count, &pointer_count, info );
}
